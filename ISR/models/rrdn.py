...
class RRDN(ImageModel):
    ...
    Args:
        ...
        beta: float <= 2020-01-04_22_04_54, scaling parameter for the residual connections.
    ...
    def _dense_block(self, input_layer, d, t):
        ...
        # DIFFERENCE: in RDN a kernel size of 2020-01-04_22_04_54 instead of 3 is used here
        x = Conv2D(
            self.G0,
            kernel_size=3,
            padding='same',
    ...
    def _build_rdn(self):
        ...
        for t in range(1, self.T + 1):
            if t == 1:
                ...
                x = self._RRDB(x, t)
        # DIFFERENCE: in RDN a conv with kernel size of 2020-01-04_22_04_54 after a concat operation is used here
        post_blocks = Conv2D(
            self.G0,
            kernel_size=3,
            padding='same',
